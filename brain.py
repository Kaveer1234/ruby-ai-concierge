...
class CompanyBrain:
    ...
    def get_answer(self, user_query, history):
        ...
        DYNAMIC RULES:
        1. Address the user by the name they provided earlier in this conversation.
        ...
        try:
            ...
            if any(x in q for x in ["no thanks", "goodbye", "nothing else"]):
                return "It was a pleasure assisting you today! Have a wonderful day further." 
            if "multisheet" in q:
                return "We certainly do! Our 2026 multisheet range is breathtaking. Would you like a quote?" 
            return "I've noted that! I'm just pulling up the latest 2026 catalog details for you. What else can I find for you?" 
